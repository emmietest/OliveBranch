...
<todo id="reservation-form">
Reservation / Booking form
Add a modal or page with a real reservation form (date, time, guests, name, email) with validation
</todo>

<todo id="menu-page">
Full menu page with category filters
Build a /menu page with tab/filter by category (Sushi, Pizza, Burgers, etc.) and all items
</todo>

<todo id="gallery-page">
Photo gallery page
Create a masonry/lightbox gallery page showcasing food and restaurant ambiance photos
</todo>

<todo id="location-map-interactive">
Interactive map with real Leaflet.js
Replace the static map tile images with a real Leaflet.js embed showing all 3 restaurant locations
</todo>

<todo id="order-flow">
Checkout / Order flow
Build a multi-step checkout: cart review → delivery info → confirmation screen
</todo>
